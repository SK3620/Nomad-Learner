...
class DepartPageViewController: UIViewController {
    ...
    private lazy var titleLabel = UILabel().then {
        $0.text = MyAppSettings.departPageTitle
    ...
    private lazy var descriptionLabel1 = UILabel().then {
        $0.attributedText = $0.createAttributedText(
            text: MyAppSettings.departPageDesc1,
            highlightedWords: [MyAppSettings.departPageBluredDesc]
        )
    }
    
    private lazy var descriptionLabel2 = UILabel().then {
        $0.attributedText = $0.createAttributedText(
            text: MyAppSettings.departPageDesc2
        )
    }
    
    private lazy var imageView = UIImageView().then {
        $0.image = UIImage(named: MyAppSettings.departPageImage)
...
extension DepartPageViewController {
